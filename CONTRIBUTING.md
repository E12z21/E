...
- Steps to reproduce
  - Be specific! Adding code always help, so make sure you do that
- What you expected would happen
- What actually happens. Displaying the error here would be great
- Versions of specified stuff. This includes OS (Windows 10 x64), Python Version, JARVIS Version, etc.
- Notes (possibly including why you think this might be happening, or stuff you tried that didn't work)

People *love* thorough bug reports. I'm not even kidding.

* The code currently uses tabs, so to keep consistency, when contributing, please also use tabs
